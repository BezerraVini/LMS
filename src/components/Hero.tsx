...
import { FaMoneyBillWave, FaMedal } from 'react-icons/fa';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="flex flex-col items-center p-6 bg-zinc-800/50 rounded-xl backdrop-blur-sm border border-slate-700">
              <FaMoneyBillWave className="w-12 h-12 text-green-500 mx-auto mb-6" />
            ...
            <div className="flex flex-col items-center p-6 bg-zinc-800/50 rounded-xl backdrop-blur-sm border border-slate-700">
              <FaMedal className="w-12 h-12 text-yellow-500 mx-auto mb-6" />
              <h3 className="text-xl font-semibold mb-2">Qualidade Garantida</h3>
              <p className="text-slate-400 text-center">Produtos originais com certificação e garantia de qualidade</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-zinc-800/50 rounded-xl backdrop-blur-sm border border-slate-700">
              <GiScooter className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Entrega rápida e segura</h3>
              <p className="text-slate-400 text-center">Seu pod chegando até você em poucos minutos com entrega rastreada</p>
            </div>
          </div>
